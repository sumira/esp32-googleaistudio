...
String analyzeImage(camera_fb_t* fb) {
  ...
  textPart["text"] = "Describe what you see in this image. Please list the main objects, their colors, and their positions.";
...
void loop() {
  ...
  String description = analyzeImage(fb);
  Serial.println("Analysis Result:");
  Serial.println(description);
  
  esp_camera_fb_return(fb);
  Serial.println("Waiting 5 seconds before next capture...");
  delay(5000);
}
